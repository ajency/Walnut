...
function chec_data_sync($redirect_to, $request, $user) {
    global $wpdb;
    $sync_count = $wpdb->get_col( "SELECT count(*) FROM {$wpdb->prefix}sync_local_data" );
...
add_action( 'login_redirect', 'chec_data_sync', 10,3 );
?>