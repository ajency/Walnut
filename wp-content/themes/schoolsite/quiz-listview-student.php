            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="direction text-center">
                        <div class="icon"><a href="<?php echo get_bloginfo( 'url' ) ?>/dashboard-student" class="btn fab-content"><i class="fa fa-hand-o-left"></i></a></div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 quiz_tiles <?php echo "S".$quiz['status'] ?> <?php echo "T".$quiz['quiz_type'] ?> <?php echo "C".$quiz['chapter_id'] ?>">
                    <div class="l-q-cards animated bounceIn">
                        <div class="l-q-cards__title">
                            ...
                            <div class="view">
                                <a href="<?php echo get_bloginfo( 'url' ) ?>/#students/dashboard/textbook/<?php echo $quiz['chapter_id'] ?>/quiz/<?php echo $quiz['quiz_id'] ?>"><img src="<?php echo STUDENT_ASSET_PATH ;?>images/view.png" class="img-responsive center-block">
                                </a>
                            </div>
                        </div>
