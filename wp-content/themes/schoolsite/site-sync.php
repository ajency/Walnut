                                        ...
                                        <?php if(current_user_can('school-admin') || current_user_can('administrator')) :?> 
                                              ...
                                              <div class="col-sm-12 b-b b-grey p-b-10 m-b-5">
                                                ...
                                                <h4 class="semi-bold text-center">Reset Sync Password</h4>
                                                      ...
                                                      <h4>If you have been provided a new sync password by Network Admin, please enter the same in the reset sync box else you can ignore this. For assistance and support contact us at <a href="mailto:support@synapsedu.info">support@synapsedu.info</a></h4>
                                                      <br/>
                                                  ...
                                                  <div class="col-sm-12  m-b-10 m-t-10">
                                                    <div class="">
                                                     <form id="validate_sync_school_user"  autocomplete="off">
                                                      ...
                                                      <label class="text-center">Enter Sync Password: </label>  
                                                      <input type="password" id="validate_pwd" value="" class="h-align-middle block"/>   
                                                      <h4>This is not the password you use to log in, it is the sync password provided by the Network Admin. If you are unable to use it please contact us at <a href="mailto:support@synapsedu.info">support@synapsedu.info</a> to send you a new sync password</h4>
                                                      <br/>
...
jQuery(document).ready(function() {
    ...
    function init_school_data_sync(referer,lastsync_id,syncstatus,blog_id,last_sync){
      ...
      var login_cookie_value = jQuery('#login_cookie_value').val();      
       ...
       jQuery(referer).next().next().html('This will take a few minutes. Please contact <a href="mailto:support@synapsedu.info">support@synapsedu.info</a> if the problem persists');
       jQuery.ajax({  
                type: 'POST',  
                url: AJAXURL,  
                data: {  
    ...
    function resync_school_data_sync(syncreference,lastsync,syncstatus,filepath,lastsync_id,blog_id){
        ...
        jQuery('#sync-media').prop('disabled', true);
        jQuery(syncreference).next().next().html('This will take a few minutes. Please contact <a href="mailto:support@synapsedu.info">support@synapsedu.info</a> if the problem persists');
    ...
    //MEDIA SYNC FUNCTIONS
        jQuery("#sync-media").on('click',function(){
                ...
                jQuery(this).next().next().html('This will take a few minutes. Please contact <a href="mailto:support@synapsedu.info">support@synapsedu.info</a> if the problem persists');
