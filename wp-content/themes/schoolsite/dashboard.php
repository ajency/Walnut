...
<head>
    ...
    <!-- BEGIN BOOK BLOCK -->
    <link href="<?php get_site_url()?>/wp-content/themes/walnut/walnut/dev/css/bookBlock/custom.css" rel="stylesheet" type="text/css">
    <link href="<?php get_site_url()?>/wp-content/themes/walnut/walnut/dev/css/bookBlock/bookblock.css" rel="stylesheet" type="text/css">
...
if (ENV == 'dev') {
    ...
    <script type="text/javascript"
            data-main="<?php get_site_url()?>/wp-content/themes/walnut/walnut/dev/js/school-main.js?ver=<?php echo DEV_VERSION ?>"
            src="<?php get_site_url()?>/wp-content/themes/walnut/walnut/dev/js/plugins/require.js"></script>
<?php
} else {

?>
    <script type="text/javascript"
            src="<?php get_site_url()?>/wp-content/themes/walnut/walnut/production/school-main.js?ver=<?php echo VERSION ?>"></script>
<?php } ?>
