...
// Returns an instance of __u for OO-style calls
function __u($item=null) {
  $__u = new __u;
  if(func_num_args() > 0) $__u->_wrapped = $item;
  return $__u;
}
...
class __u {
  ...
  public function chain($item=null) {
    ...
    $__u = (isset($this) && isset($this->_chained) && $this->_chained) ? $this : __u($item);
    $__u->_chained = true;
    return $__u;
  }
  ...
  public function reduceRight($collection=null, $iterator=null, $memo=null) {
    ...
    $__u = new self;
    return self::_wrap($__u->reduce($collection, $iterator, $memo));
  }
  ...
  public function invoke($collection=null, $function_name=null, $arguments=null) {
    ...
    $__u = new self;
    list($collection, $function_name) = $__u->first($args, 2);
    $arguments = $__u->rest(func_get_args(), 2);
  ...
  public function any($collection=null, $iterator=null) {
    ...
    $__u = new self;
    if(!is_null($iterator)) $collection = $__u->map($collection, $iterator);
  ...
  public function initial($collection=null, $n=null) {
    ...
    $__u = new self;
    return self::_wrap($__u->first($collection, $first_index));
  }
  ...
  public function compact($collection=null) {
    ...
    $__u = new self;
    return self::_wrap($__u->select($collection, function($val) {
      return (bool) $val;
    }));
  }
  ...
  public function flatten($collection=null, $shallow=null) {
    ...
    if(count($collection) > 0) {
      foreach($collection as $item) {
        if(is_array($item)) {
          $__u = new self;
          $return = array_merge($return, ($shallow) ? $item : $__u->flatten($item));
        }
        else $return[] = $item;
      }
    }
  ...
  public function intersection($array=null) {
    ...
    $__u = new self;
    $return = $__u->first($arrays);
    foreach($__u->rest($arrays) as $next) {
      if(!$__u->isArray($next)) $next = str_split((string) $next);
  ...
  public function union($array=null) {
    ...
    $__u = new self;
    return self::_wrap($__u->flatten(array_values(array_unique(call_user_func_array('array_merge', $arrays)))));
  }
  ...
  public function lastIndexOf($collection=null, $item=null) {
    ...
    krsort($collection);
    $__u = new self;
    return self::_wrap($__u->indexOf($collection, $item));
  }
  ...
  public function range($stop=null) {
    ...
    $__u = new self;
    $args = $__u->reject($args, function($val) {
      return is_null($val);
    });
    ...
    if($step > 0 && $__u->last($results) >= $stop) array_pop($results);
    elseif($step < 0 && $__u->last($results) <= $stop) array_pop($results);
  ...
  public function zip($array=null) {
    ...
    $__u = new self;
    $num_return_arrays = $__u->max($__u->map($arrays, function($array) {
      return count($array);
    }));
    $return_arrays = $__u->range($num_return_arrays);
  ...
  public function max($collection=null, $iterator=null) {
    ...
    arsort($results);
    $__u = new self;
    $first_key = $__u->first(array_keys($results));
  ...
  public function extend($object=null) {
    ...
    $array = (array) $object;
    $__u = new self;
    $extensions = $__u->rest(func_get_args());
  ...
  public function isEqual($a=null, $b=null) {
    ...
    if(is_object($a) || is_array($a)) {
      ...
      $__u = new self;
      $keys_equal = $__u->isEqual($__u->keys($a), $__u->keys($b));
      $values_equal = $__u->isEqual($__u->values($a), $__u->values($b));
