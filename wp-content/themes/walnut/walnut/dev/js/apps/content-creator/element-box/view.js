  ...
  return App.module("ContentCreator.ElementBox.Views", function(Views, App) {
    return Views.ElementBoxView = (function(_super) {
      ...
      ElementBoxView.prototype.onShow = function() {
        ...
        this.on("question:dropped", (function(_this) {
          return function() {
            return _this.$el.find('.qstns').find('*[data-element]').draggable('disable');
          };
        })(this));
        return this.on("question:removed", (function(_this) {
          return function() {
            return _this.$el.find('.qstns').find('*[data-element]').draggable('enable');
          };
        })(this));
      };
