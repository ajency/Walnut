...
define(['app'], function(App) {
  return App.module("ContentCreator.ContentPieces.Views", function(Views, App) {
    ...
    ContentPiecesIV = (function(_super) {
      ...
      ContentPiecesIV.prototype.template = '{{&excerpt}}<br> <label class="form-label list-group-item-text"> {{contentType}} </label>';
    ...
    return Views.ContentPieces = (function(_super) {
      ...
      ContentPieces.prototype.collectionEvents = function() {
        return {
          'reset': function() {
            ...
            return this.$el.find('#textbookNames').html("Textbook: <b>" + textbookNames + "</b> | Chapter: <b>" + chapterNames + "</b>");
          }
        };
      };
      ...
      ContentPieces.prototype.mixinTemplateHelpers = function(data) {
        ...
        textbookNames = _.unique(this.collection.pluck('textbookName'));
        chapterNames = _.unique(this.collection.pluck('chapterName'));
        data.textbookNames = "Textbook: <b>" + textbookNames + "</b> | Chapter: <b>" + chapterNames + "</b>";
        return data;
      };
