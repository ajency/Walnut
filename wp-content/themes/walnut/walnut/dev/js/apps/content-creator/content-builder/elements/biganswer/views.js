...
define(['app'], function(App) {
  return App.module("ContentCreator.ContentBuilder.Element.BigAnswer.Views", function(Views, App, Backbone, Marionette, $, _) {
    return Views.BigAnswerView = (function(_super) {
      ...
      BigAnswerView.prototype.template = '<textarea  type="text" maxlength="{{maxlength}}"  style=" font-family: {{font}}; font-size: {{font_size}}px; color: {{color}}; max-width:100%; width :100%; height: 100%; line-height : inherit;">';
