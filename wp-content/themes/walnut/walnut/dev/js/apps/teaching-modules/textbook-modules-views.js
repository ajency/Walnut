...
define(['app'], function(App) {
  return App.module("TeachersDashboardApp.View.TakeClassTextbookModules", function(TextbookModules, App) {
    ...
    return TextbookModules.ContentGroupsView = (function(_super) {
      ...
      ContentGroupsView.prototype.template = '<div class="tiles white grid simple  animated fadeIn"> <div class="grid-title"> <h3 class="m-t-5 m-b-5">Textbook <span class="semi-bold">{{showTextbookName}}</span></h3> </div> <div class="grid-body contentSelect" style="overflow: hidden; display: block;"> <div class="row"> <div class="col-xs-12"> <div class="filters"> <div class="table-tools-actions"> <span id="textbook-filters"></span> </div> </div> </div> <div class="clearfix"></div> <div class="col-sm-12"></div> </div> <div class="row m-t-15"> <div class="col-lg-12"> <!--<h4>{{&showModulesHeading}}</h4>--> <table class="table table-condensed table-fixed-layout table-bordered takeClass" id="take-class-modules"> <thead> <tr> <th>Name</th> <th>Chapter</th> <th class="{sorter:\'minutesSort\'}">Duration</th> <th><div id="status_header">Status</div></th> </tr> </thead> <tbody> </tbody> </table> </div> </div> </div> </div>';
