  ...
  return App.module("ContentSelectionApp.Controller.SearchResults", function(SearchResults, App, Backbone, Marionette, $, _) {
    SearchResults.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(opts) {
        ...
        this.searchCollection = App.request("get:content:pieces");
        this.view = view = this._getContentSelectionView(this.searchCollection);
        this.show(this.view, {
          loading: true
        });
        return this.listenTo(this.view, "search:content", this._searchContent);
      };
      ...
      Controller.prototype._searchContent = function(searchStr) {
        ...
        App.execute("when:fetched", newCollection, (function(_this) {
          return function() {
            _this.searchCollection.reset(newCollection.models);
            return _this.view.triggerMethod("search:complete", _this.searchCollection);
          };
        })(this));
          ...
          "add:content:pieces": (function(_this) {
            return function(contentIDs) {
              return _.each(contentIDs, function(ele, index) {
                _this.contentGroupCollection.add(_this.searchCollection.get(ele));
                return _this.searchCollection.remove(ele);
              });
            };
          })(this)
        });
      ...
      Controller.prototype.contentPieceRemoved = function(model) {
        this.searchCollection.add(model);
      ...
      DataContentTableView = (function(_super1) {
        ...
        function DataContentTableView() {
          this.onSearchComplete = __bind(this.onSearchComplete, this);
        ...
        DataContentTableView.prototype.template = 'Search Questions: <input type="text" class="search-box" id="search-box"> <br><br>' + contentSelectionTpl;
        ...
        DataContentTableView.prototype.onShow = function() {
          this.$el.find('#data-content-area').hide();
        ...
        DataContentTableView.prototype.searchContent = function(e) {
          var p, searchStr;
          p = e.which;
          if (p === 13) {
        ...
        DataContentTableView.prototype.onSearchComplete = function() {
          this.$el.find('#data-content-area').show();
          return this.updatePager();
        };
        ...
        DataContentTableView.prototype.updatePager = function() {
          ...
          return this.$el.find("#dataContentTable").tablesorter().tablesorterPager(pagerOptions);
        };
