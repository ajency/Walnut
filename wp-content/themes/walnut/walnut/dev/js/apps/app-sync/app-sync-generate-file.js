    ...
    getDataFromQuestionResponse: function() {
      ...
      onSuccess = function(d) {
        return function(tx, data) {
          ...
          _fn = function(i, row) {
            return question_response_data[i] = [row.ref_id, row.teacher_id, row.content_piece_id, row.collection_id, row.division, row.question_response, row.time_taken, row.start_date, row.end_date, row.status, row.sync];
          };
