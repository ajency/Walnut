...
define(['app', 'controllers/region-controller', 'text!apps/take-module-item/module-description/templates/module-description-template.html', 'bootbox'], function(App, RegionController, moduleDescriptionTemplate, bootbox) {
  return App.module("TeacherTeachingApp.ModuleDescription", function(ModuleDescription, App) {
    var ModuleDescriptionController;
    return ModuleDescriptionController = (function(_super) {
...
({
  ...
  _changeQuestion: (function(_this) {
    return function() {
      _this.region.trigger("goto:next:question");
      _this.nextItemID = _this._getNextItemID(_this.nextItemID);
      return _this.view.triggerMethod("question:changed", _this.nextItemID);
    };
  })(this),
  _getNextItemID: (function(_this) {
    return function(item_id) {
      var contentPieces, nextItemID, pieceIndex;
      contentPieces = _this.model.get('content_pieces');
  ...
  _showModuleDescriptionView: (function(_this) {
    return function(model) {
      var numOfQuestionsCompleted, terms, timeTakenArray, totalNumofQuestions, totalTimeTakenForModule;
      terms = model.get('term_ids');
      numOfQuestionsCompleted = _.size(_this.questionResponseCollection.where({
        "status": "completed"
      }));
...
App.commands.setHandler("show:teacher:teaching:module:description", function(opt) {
  if (opt == null) {
    opt = {};
  }
