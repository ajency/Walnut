...
define(['app', 'controllers/region-controller', 'apps/content-preview/view'], function(App, RegionController) {
        ...
        this.listenTo(this.layout, 'show', (function(_this) {
          return function() {
            App.execute("show:preview:question:", {
              region: _this.layout.contentPreviewRegion
            });
            return App.execute("show:result", {
              region: _this.layout.previewResultRegion
            });
          };
        })(this));
