...
define(['app', 'controllers/region-controller', 'text!apps/students-dashboard/textbooks/templates/class-description.html', 'apps/students-dashboard/textbooks/views'], function(App, RegionController, classDescriptionTpl) {
