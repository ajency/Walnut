define ['app'
        ...
        'apps/student-training-module/take-module/item-description/view'
], (App, RegionController)->
    App.module "StudentTrainingApp.TopPanel", (TopPanel, App, Backbone, Marionette, $, _)->
        class TopPanel.Controller extends RegionController

            initialize : (options)->
                {@model,@questionResponseModel,@timerObject, @display_mode,@classID,@students,is_student_training_module} = options
                ...
                @view = @_showView is_student_training_module: is_student_training_module
                ...
                @listenTo @view, "top:panel:previous",->
                    @region.trigger "top:panel:previous"
            ...
            _showView :(is_student_training_module)->
        ...
        App.commands.setHandler 'show:student:top:panel', (options)->
