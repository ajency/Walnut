	...
	App.module 'Media.Grid.Views', (Views, App)->
		...
		class MediaView extends Marionette.ItemView
			...
			mixinTemplateHelpers : (data)->
				...
				if data.type is 'image' and data.sizes 
					if data.sizes.thumbnail and data.sizes.thumbnail.url
						data.imageUrl = data.sizes.thumbnail.url 
					else if data.sizes.full and data.sizes.full.url
						data.imageUrl = data.sizes.full.url 
							
				data.imagePreview  = true if data.imageUrl
