...
#                        theta =  option.rotation()
#
#                        newPx = Math.cos(theta)*option.width()/2 - Math.sin(theta)*option.height()/2 + option.x()
#                        newPy = Math.cos(theta)*option.height()/2 + Math.sin(theta)*option.width()/2 + option.y()
#
