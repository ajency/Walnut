    ...
    (Views, App, Backbone, Marionette, $, _)->
        ...
        class Views.ImageWithTextView extends Marionette.ItemView
            ...
            configureEditor: (event) =>
                ...
                if element.getAttribute('id') is @$el.children('.editor').attr 'id'
                    editor.on 'configLoaded', ->
                        editor.config.placeholder = 'Your text goes here. You can change
                             the format of the text using the text editor provided. Upload
                             image by clicking on the image placeholder...'
