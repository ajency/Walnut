define ['app'
        ...
        'apps/content-creator/content-builder/elements/imagewithtext/settings/views'],
(App, AppController)->
    App.module 'ContentCreator.ContentBuilder.Element.ImageWithText.Settings',
    (Settings, App, Backbone, Marionette, $, _)->
