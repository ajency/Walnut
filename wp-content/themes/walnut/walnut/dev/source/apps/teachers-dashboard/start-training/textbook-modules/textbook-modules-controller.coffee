define ['app'
		...
		'apps/teachers-dashboard/start-training/textbook-modules/textbook-modules-views'
	...
	App.module "TeachersDashboardApp.View", (View, App)->
		...
		class View.startTrainingTextbookModulesController extends RegionController
			initialize : (opts) ->
				...
				App.execute "when:fetched", @textbook, =>
					...
					breadcrumb_items = 'items':[
							...
							{'label':'Start Training','link':'#teachers/start-training/'+@classID},
			...
			_getContentGroupsListingView : (collection)=>
				new View.StartTrainingTextbookModules.ContentGroupsView
