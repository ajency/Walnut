define ['app'
    ...
    App.module "DashboardTakeClassApp.Controller", (Controller, App)->

        class Controller.DashboardTakeClassController extends RegionController

            initialize :(opts) ->

                @view= view = @_getTakeClassView opts.divisionsCollection
        ...
        # set handlers
        App.commands.setHandler "show:dashboard:takeclass:app", (opt = {})->
            new Controller.DashboardTakeClassController opt
