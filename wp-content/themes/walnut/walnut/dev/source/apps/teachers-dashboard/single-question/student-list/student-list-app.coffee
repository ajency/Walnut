define ['app'
	...
	App.module "SingleQuestionStudentsListApp.Controller", (Controller, App)->

		class Controller.SingleQuestionStudentsList extends RegionController
			...
			initialize : (opts)->
				...
				App.execute "when:fetched",	@questionResponseCollection, =>
					@questionResponseModel = @questionResponseCollection.findWhere 
												...
												'content_piece_id': @questionID.toString()
			...
			showViews:=>
				...
				@listenTo view, "question:completed", => view.close()											
		...
		class StudentsList extends Marionette.CompositeView
		...
		App.commands.setHandler "show:single:question:student:list:app", (opt = {})->
			new Controller.SingleQuestionStudentsList opt		
