        ...
        createLocalTables : (db)->
            ...
            db.transaction((tx)->
                ...
                tx.executeSql('CREATE TABLE IF NOT EXISTS wp_posts (ID INTEGER PRIMARY KEY, post_author INTEGER
                             , post_date TEXT, post_date_gmt TEXT, post_content TEXT, post_title TEXT
                             , post_excerpt TEXT, post_status TEXT, comment_status TEXT, ping_status TEXT
                             , post_password TEXT, post_name TEXT, to_ping TEXT, pinged TEXT
                             , post_modified TEXT, post_modified_gmt TEXT, post_content_filtered TEXT
                             , post_parent INTEGER, guid TEXT, menu_order INTEGER, post_type TEXT
                ...
                tx.executeSql('CREATE TABLE IF NOT EXISTS wp_content_collection (id INTEGER PRIMARY KEY
                             ...
                             , last_modified_by INTEGER, published_on TEXT
                             , published_by INTEGER, status TEXT, type TEXT, term_ids TEXT, duration INTEGER)')
