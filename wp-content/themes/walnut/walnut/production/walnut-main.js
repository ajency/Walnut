...
define("search_results", function(){});
...
for(var k=1;k<e.length;k++){h=e.charAt(k);if(-1=="0123456789.".indexOf(h))return null;if("."==h){if(j)return null;j=!0}}return"numeric"},function(e){var h=Date.parse(e);return null!==h&&!isNaN(h)||"string"===typeof e&&0===e.length?"date":null},function(e){return"string"===typeof e&&-1!=e.indexOf("<")&&-1!=e.indexOf(">")?"html":null}]);h.fn.DataTable=j;h.fn.dataTable=j;h.fn.dataTableSettings=j.settings;h.fn.dataTableExt=j.ext};"function"===typeof define&&define.amd?define('jquery_datatables',["jquery"],L):jQuery&&!jQuery.fn.dataTable&&
...
;
define("datatables_responsive", function(){});
...
define('plugins/walnut-pluginloader',['underscore', 'jquery', 'backbone', 'marionette', 'syphon', 'text', 'jqueryvalidate', 'sidr', 'slimroll', 'core', 'breakpoints', 'mustache', 'spin', 'jqueryspin', 'mixitup', 'search_results', 'bootstrap', 'jquery_datatables', 'tabletools', 'datatables_responsive', 'datatables', 'unveil', 'pace'], function() {});
...
(function(root, undefined) {
    ...
    if (typeof define === "function" && define.amd) {
        define('plugins/detect',['require'],function(require) {
            return detect;
        });
    }
})(window);
...
define('config/middle-layer',['plugins/detect', 'jquery', 'plugins/online'], function(detect, $) {
...
define('config/walnut-configloader',['config/marionette', 'config/backbone', 'config/jquery-validate', 'config/middle-layer'], function() {});
...
define('apps/textbooks/list/views',['app', 'text!apps/textbooks/templates/textbooks.html', 'text!apps/textbooks/list/templates/list_item.html', 'text!apps/textbooks/templates/no_textbooks.html'], function(App, textbooksTpl, listitemTpl, notextbooksTpl) {
...
define('text!apps/textbooks/textbook-single/templates/textbook-full.html',[],function () { return '<div class="content">\n\t\t\t<ul class="breadcrumb">\n\t\t\t\t<li>\n\t\t\t\t  <p>Dashboard</p>\n\t\t\t\t</li>\n\t\t\t\t<li>\n\t\t\t\t  <a href="#"> Content Management</a>\n\t\t\t\t</li>\n\t\t\t\t<li>\n\t\t\t\t  <a href="#"> Textbooks</a>\n\t\t\t\t</li>\n\t\t\t\t<li><a href="#" class="active"> Textbook ABC</a> </li>\n\t\t\t</ul>\n\t\t\t<!-- BEGIN PlACE PAGE CONTENT HERE -->\n\t\t\t<div class="row">\n\t\t\t\t<div class="col-lg-5">\n\t\t\t\t\t<div id="textbook-description-region"></div>\t\n\t\t\t\t</div>\n\t\t\t\t<div class="col-lg-7">\n\t\t\t\t\t<div id="chapters-list-region"></div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<!-- END PLACE PAGE CONTENT HERE -->\n\t\t</div>\n\t\t';});
...
define('text!apps/textbooks/textbook-single/templates/chapter-list-item.html',[],function () { return '<td class=" "><a href="#section">{{name}}</a></td>\n<td class=" ">{{chapter_count}}</td>\n<td class=" ">{{count}}</td>\n<td class="center "> 0</td>';});
...
define('apps/walnut-appsloader',['apps/login/loginapp', 'apps/header/headerapp', 'apps/left-nav/leftnavapp', 'apps/textbooks/app'], function() {});
...
define('entities/walnut-entities-loader',['entities/base-entities', 'entities/user', 'entities/menu', 'entities/textbooks', 'entities/chapters'], function() {});
