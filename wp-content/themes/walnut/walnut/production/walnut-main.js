...
define('plugins/walnut-pluginloader',['underscore', 'jquery', 'backbone', 'marionette', 'syphon', 'text', 'jqueryvalidate', 'sidr', 'slimroll', 'core', 'breakpoints', 'mustache', 'spin', 'jqueryspin', 'mixitup', 'search_results', 'bootstrap', 'jquery_datatables', 'tabletools', 'datatables_responsive', 'datatables', 'unveil'], function() {});
...
define('entities/walnut-entities-loader',['entities/base-entities', 'entities/user', 'entities/menu', 'entities/textbooks'], function() {});
