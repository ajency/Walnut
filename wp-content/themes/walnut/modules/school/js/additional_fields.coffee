jQuery(document).ready ($)-> 
    $('#add-new-site').next().find('table tbody').append('
        ...
        <tr class="form-field form-required">
                ...
                <td><input id="validfrom" name="blog_additional[validfrom]" type="text" class="regular-text date-field" title="Valid From"/></td>
        </tr>
        <tr class="form-field form-required">
                <th scope="row">Valid To <span style="color:#ff0000; font-size:11px; font-style:italic">(required</span></th>
                <td><input id="validto" name="blog_additional[validto]" type="text" class="regular-text date-field" title="Valid To"/></td>
        </tr>
        <tr class="form-field form-required">
